...
from keras.layers import Dense, K, regularizers, BatchNormalization, Activation, MaxPooling1D, \
...
class Deep1DResnetClassifier(Classifier):
    def __init__(self, L, labels) -> None:
        super().__init__(L, labels)
        self._model = self._build()
        self._name = "Deep1DResnetClassifier"
